...
Wiley - Ernest P. Chan - Algorithmic Trading Winning Strategies and their Rationale (Pending ⏱️)
Wiley - Ernest P. Chan - Machine Trading Deploying Computer Algorithms To Conquer the Markets (Pending ⏱️)
...
- O'Reilly - Andreas Antonopoulos - Mastering Bitcoin
- O'Reilly - Andreas Antonopoulos and Gavin Wood - Mastering Ethereum
- APress - Santiago Palladino - Ethereum for Web Developers
...
## 🐧📕 Linux - DevOps - Serverless Books

- Packt - Emmanouil Gkatziouras - A Developer's Essential Guide to Docker Compose
- Packt - Jeroen Mulder - Enterprise DevOps for Architects
- Packt - Ahmed AlKabary - Learn Linux Quickly
- Packt - Gaurav Agarwal - Modern DevOps Practices
- Packt - Brian Zambrano - Serverless Design Patterns and Best Practices
...
- Packt - Joshua Alan Teter - Technical Program Manager's Handbook